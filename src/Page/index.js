        ...
        return (
            <div>
                ...
                <ul className = "ul1">
                    ...
                    <ul className = "ul2">
                        {
                            this.state.notClickable
                            ? <a id = "dis" target = "_blanck" className = "Button" href = {"https://www.urionlinejudge.com.br/judge/pt/problems/view/" + this.state.problem}>Acessar problema</a>
